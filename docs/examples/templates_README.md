...
- See [EXTENDING_ARTEMIS.md](../EXTENDING_ARTEMIS.md) for comprehensive guide (when available)
- See [QUICK_REFERENCE.md](../QUICK_REFERENCE.md) for quick reference (when available)
