...
- PDF/DOCX loading (basic tests, full tests require actual files)
...
- Agentic chunker (skipped - placeholder)
...
- CSV with schemas
- Error handling
- PDF/DOCX ingestion (requires actual files or mocking)
...
See [WHAT_TO_ADD.md](WHAT_TO_ADD.md) and [DATA_REQUIREMENTS.md](DATA_REQUIREMENTS.md) for test data setup.
...
- for passed tests
- for skipped tests (missing dependencies)
